...
CHIRIMEN with micro:bitでは、PCのブラウザ上で動かすウェブアプリケーションを開発します。mircro:bit側のプログラム開発は基本的に必要ありません。ただし、Bluetooth経由でGPIOやI2C端子などを使用できるようにする<span class="notranslate"><a href="https://makecode.microbit.org/_DEy9fTMpreEu" target="_blank"></span>専用のサポートプログラム</a>をmicro:bitに書き込んでおく必要があります。

- <span class="notranslate"><a href="https://makecode.microbit.org/_DEy9fTMpreEu" target="_blank">こちらのページ</a></span>にアクセスして、micro:bitにサポートプログラムを書き込みます。<br>

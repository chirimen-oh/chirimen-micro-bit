...
var tMaxTxt,tMinTxt,tMaxUI,tMinUI;

async function connect(){
	initTable();
	tMaxTxt = document.getElementById("tMaxTxt");
	tMinTxt = document.getElementById("tMinTxt");
	tMaxUI = document.getElementById("tMaxUI");
	tMinUI = document.getElementById("tMinUI");
